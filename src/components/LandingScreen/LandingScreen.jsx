    ...
    return (
        <div className='landing-screen'>
            <div className="container">
                ...
                <div className="div-dev"><h1>{french ? "Développeur Web Full Stack" : "Full Stack Web Developer"}</h1></div>
                <div className="links">
                    <a href="https://github.com/bast44trl" target="blank" className="git">
                        <img src={git} alt="My Github account" />
                    </a>
                    <a href='mailto:bastien.traille@gmail.com'><img src={email} alt="email icon" /></a>
