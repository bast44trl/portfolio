...
import './themeAndBackground.scss';
    ...
    return (
        <div className="theme-container">
            ...
            <div className='bg-buttons'>
                <div className="bg-montains" onClick={() => handleBgMontains()}><img src={montainImg} alt="montains" /></div>
                <div className="bg-sunset" onClick={() => handleBgSunset()}><img src={sunsetImg} alt="sunset" /></div>
                <div className="bg-smoke" onClick={() => handleBgSmoke()}><img src={smokeImg} alt="smoke" /></div>
                <div className="bg-ocean" onClick={() => handleBgOcean()}><img src={oceanImg} alt="ocean" /></div>
                <div className='bg-tech' onClick={() => handleBgTech()}><img src={techImg} alt="tech" /></div>
            </div>
        </div>
    );
};
