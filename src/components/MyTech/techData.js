...
export const logos = [
  ...
  },
  {
    ...
    techTextEnglish:
      'Express is a back end web application framework for Node.js, designed for building web applications and APIs.',
    techName: 'Express',
    logo: logoExpress,
  ...
  },
  {
    ...
    techTextEnglish:
      'MySQL (Structured Query Language) is an open-source relational database management system (RDBMS)',
    techName: 'MySql',
    logo: logoSql,
  ...
  {
    techTextFrench:
      'Postman est une application permettant de construire et de tester des API.',
    techTextEnglish:
      'Postman is an API platform for building and using APIs. Postman simplifies each step of the API lifecycle so you can create better APIs—faster.',
    techName: 'Postman',
    logo: logoPostman,
